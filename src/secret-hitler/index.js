        ...
        case 'confirm':
          if (game) {
            ...
            await channel.send(
              ...
              'Type `~/sh start` to start one.'
            )
          }
          break
        case 'help':
          await channel.send('THERE IS NO HELP')
          break
        case 'bearfact':
          const bearFact = bearFacts[bearFacts.length * Math.random() | 0]
